...
const SetPasswordScreen: React.FC<null> = (props) => {
    const renderHeader = (): JSX.Element => {
        return <View style={styles.header}>
            <View style={styles.headerLeft}>
                ...
                <TextSemiBold text="Set Unlock Password" style={styles.headerTitle} />
            </View>

            <View style={styles.headerRight}>
                <TouchableOpacity onPress={() => props.navigation.navigate("ConfirmPasswordScreen")}>
